...
const knowledge = [
  ...
  { keys: ['dream mantra id', 'user id', 'registration id', 'my id'], en: 'Your Dream Mantra ID is assigned at signup (shown on Dashboard Overview). Use it for login verification, tests, and support. Forgot password: Security tab or 9680102276.', hi: 'Dream Mantra ID signup पर मिलता है — Dashboard Overview पर।' },
