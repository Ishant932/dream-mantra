/**
 * Comprehensive Dream Mantra / Dreamz Roadmap knowledge base
...
SOCIAL: Instagram @dreamz.roadmap | LinkedIn: Dreamz Roadmap | Facebook: Dreamz

BOOKING CONSULTATIONS (LIVE CALENDAR):
• Counselling slot booking requires a CONFIRMED paid module with counselling access:
  – Combo ₹2,999 (counselling included) | Mind/Skill + add-on ₹699 | CRP ₹1,499 | Top-up ₹999
• Users log in → Dashboard → Book tab (/dashboard?tab=book)
• Live calendar shows admin-approved open slots (online Pan-India or offline Jaipur)
• Pick a slot, choose program (Class 1-5 through Working Professionals), add notes, confirm booking
...
• Dashboard tabs: Overview, Profile, Modules (assessments), Book (consultation slots), Careers, AI Corner, Roadmap, Security
• Modules tab — book and take Mind Mapping, Skill Mapping & combo assessments after payment
...
6. Future AI Proof — careers resilient to automation
...
• College Students: Degree clarity, internships, job prep (/programs/college-students)
...
5 sessions × 1.5 hours (7.5 hours total):
Session 1: Personal Branding, Tell Me About Yourself, Video Resume, Elevator Pitch
Session 2: LinkedIn Optimization, Naukri/Job Portals, Digital Portfolio
Session 3: Resume/CV, Cover Letter Optimization
Session 4: Interview Skills, Mock Interviews, Group Discussion
Session 5: Campus to Corporate, Salary Negotiation, Recruiters Contact Details Jaipur
...
PARTNER WITH US:
Schools, Coaching Centers, Colleges, Corporates, Teachers, Referral Partners — visit /partner/schools or /contact

CAREERS: 950+ at /careers — education, salary, skills, exams, roadmaps, AI resilience scores

RULES FOR ANSWERING:
1. Answer the user's question fully and accurately first — be specific, helpful, warm. Only use facts from this knowledge base.
2. For stream questions (PCM, PCB, Commerce, Arts): give careers, exams, skills FIRST, then suggest Dream Mantra assessments.
3. Always offer free consultation: 9680102276 or /contact when relevant.
4. Respond in user's language (English or Hindi).
5. Never invent exact fees — say contact for pricing. Initial consultation is FREE.
6. If unsure, suggest booking with certified counsellor at 9680102276.
7. FORMAT: Plain text only. No markdown, no asterisks (*), no **bold**. Use short paragraphs and numbered lists (1. 2. 3.) when needed. Keep answers clear and readable.
`;
...
export const DREAMZ_KNOWLEDGE = [
  ...
  },
  {
    ...
    en: 'Class 11-12 Career Direction Program: Choose right stream subjects, prepare for entrance exams (JEE/NEET/CUET/CLAT), select colleges, and build career roadmap. Includes academic audit + skill mapping fit + market trend analysis. Visit /programs/class-11-12 | Book: 9680102276',
    hi: 'Class 11-12: stream subjects, entrance exams, college selection, career roadmap। /programs/class-11-12',
  },
  {
    keys: ['college student', 'college students', 'degree', 'internship', 'campus placement'],
    en: 'College Students Program: Get clarity on degree relevance, internships, skill gaps, and job readiness. Includes AI Career Launchpad — LinkedIn, resume, interviews, salary negotiation. /programs/college-students | /crp | 9680102276',
    hi: 'College students: degree clarity, internships, AI Career Launchpad for job readiness। /programs/college-students',
  },
  {
  ...
  },
  {
    ...
    en: 'Book Your FREE Consultation with our live calendar:\n1. Log in at /login\n2. Open Dashboard → Book tab (/dashboard?tab=book)\n3. Pick an open slot from the live calendar (online Pan-India or offline Jaipur)\n4. Choose your program and confirm\n\nAlso available Mon-Sat 11am-7pm by phone: 📞 9680102276 | 📧 info@dreammantra.in | /contact',
    hi: 'मुफ्त consultation: Dashboard → Book tab (/dashboard?tab=book) पर live calendar से slot चुनें। सोम-शनि 11am-7pm। 9680102276',
  },
  {
  ...
  {
    keys: ['other services', 'career awareness', 'profile building', 'study abroad', 'education loan'],
    en: 'Additional Services at Dream Mantra:\n• Career awareness sessions for schools\n• Profile building & internship guidance\n• Education loan guidance\n• Study abroad support\n• Education & career counselling for all age groups\nContact for details: 9680102276 | /contact',
    hi: 'अन्य सेवाएं: career awareness, profile building, education loan, study abroad। 9680102276',
  },
  {
  ...
  },
  {
    ...
    en: 'Partner Programs:\n• Coaching Centers — career guidance add-on\n• Colleges — placement & career readiness\n• Corporates — employee career development\n• Referral Partners — earn by referring students\nContact: /contact | 9680102276',
    hi: 'Partnership: coaching, colleges, corporates, referral। /contact',
  },
  {
    keys: ['mbti', 'disc', 'riasec', 'big 5', 'vak', 'jung', '7 framework', 'seven framework'],
    en: 'Skill Mapping — 7 Frameworks:\n1. MBTI — personality types\n2. DISC — behaviour & communication\n3. RIASEC — career interests (Realistic, Investigative, Artistic, Social, Enterprising, Conventional)\n4. Big 5 — openness, conscientiousness, extraversion, agreeableness, neuroticism\n5. VAK — Visual, Auditory, Kinesthetic learning\n6. MIT — Multiple Intelligence Theory\n7. Jung — archetypes & cognitive functions\nBook: /assessments/psychometric | 9680102276',
    hi: '7 Skill Mapping frameworks: MBTI, DISC, RIASEC, Big 5, VAK, MIT, Jung। /assessments/psychometric',
  },
  {
  ...
  },
  {
    ...
    en: 'Career awareness sessions help students discover possibilities they never knew existed. Myra (Class 8)\'s parent shared: "She\'s excited about her future now." We offer career awareness for Class 6-12. Program: /programs/class-6-8 | Book: 9680102276',
    hi: 'Career awareness — Myra (Class 8) excited about future। /programs/class-6-8',
  },
  {
    keys: ['vikram', 'professional', 'career switch', 'monday', 'stuck job'],
    en: 'Vikram was stuck in marketing that didn\'t fit. Dream Mantra Skill Mapping + counselling revealed his real strengths. He switched careers and now actually enjoys Mondays! Working Professionals program: /programs/working-professionals | 9680102276',
    hi: 'Vikram — career switch, अब Mondays enjoy करता है। /programs/working-professionals',
  },
  {
  ...
  {
    keys: ['hours', 'timing', 'open', 'when open', 'available'],
    en: 'Dream Mantra is open Mon-Sat, 11am-7pm. Online counselling available Pan-India. Offline centres in Jaipur: Raja Park, Shastri Nagar, Nirman Nagar. Call 9680102276 or email info@dreammantra.in',
    hi: 'समय: सोम-शनि 11am-7pm। Online Pan-India + Jaipur centres। 9680102276',
  },
  {
...
export function matchDreamzKnowledge(message, lang = 'en') {
  const text = message.toLowerCase().replace(/[^\w\s@.?]/g, ' ');
  const words = text.split(/\s+/).filter((w) => w.length > 2);
  let best = null;
  let bestScore = 0;

  for (const item of DREAMZ_KNOWLEDGE) {
    let score = 0;
    for (const key of item.keys) {
      const k = key.toLowerCase();
      if (text.includes(k)) score += k.split(' ').length * 3;
      else if (words.some((w) => w.length > 3 && (k.includes(w) || k.split(' ').some((p) => p.startsWith(w.slice(0, 4)))))) {
        score += 1;
      }
    }
    if (score > bestScore) {
  ...
  if (bestScore >= 1) return best[lang] || best.en;
  return null;
}
