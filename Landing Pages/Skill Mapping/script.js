...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (typedTextElement) {
    const words = ["Personality Type", "Career Fit", "Hidden Strength", "True Potential"];
    let wordIndex = 0;
    let charIndex = 0;
  ...
  if (leadForm) {
    leadForm.addEventListener('submit', (e) => {
      ...
      const whatsappMsg = encodeURIComponent(
        `Hi Esha Ma'am! I just booked Skill Mapping via the Landing Page.\n\n👤 Name: ${name}\n📧 Email: ${email}\n📱 Phone: ${phone}\n\nPlease confirm my assessment slot!`
      );
