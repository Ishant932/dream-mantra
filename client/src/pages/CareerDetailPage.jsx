...
export default function CareerDetailPage() {
  ...
  const baseWaHref = useWhatsAppAgentLink();
  ...
  const careerWaHref = career?.title
    ? getWhatsAppAgentLink({ text: `Hi Esh, I want guidance on becoming a ${career.title}.`, sandbox: baseWaHref.includes('join') })
    : baseWaHref;
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="relative max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <a
              ...
              className="career-wa-cta inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold"
            >
              <WhatsAppIcon className="w-4 h-4" />
              Ask Esh about this career
            </a>
