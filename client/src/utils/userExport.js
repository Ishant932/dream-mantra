...
function profileFields(user = {}) {
  ...
  return [
    ...
    { label: 'School / College', value: p.schoolOrCollege },
    { label: 'City', value: p.city },
    { label: 'State', value: p.state },
    { label: 'Career goal', value: p.careerGoal },
    { label: 'Hobbies', value: p.hobbies },
    { label: 'Biggest challenge', value: p.biggestChallenge },
    ...
    { label: 'Preferred counselling mode', value: p.preferredMode },
    { label: 'How heard about us', value: p.howHeard },
