...
export const SKILL_MAPPING_INSTRUMENTS = [
  { id: 'RIASEC', emoji: '🧠', title: 'Career Interest Assessment', framework: 'Career Interest Assessment', tag: 'Career Interest Preferences', hint: 'Finds the careers and work environments that match your interests.', total: 24, question: 'I enjoy exploring new places and outdoor activities.', options: ['Agree', 'Neutral', 'Disagree'] },
  { id: 'MIT', emoji: '🌟', title: 'Multiple Talents Assessment', framework: 'Multiple Talents Assessment', tag: 'Multiple Talents Profile', hint: 'Identifies your strongest multiple abilities and areas of intelligence.', total: 24, question: 'I can easily pick up new tunes or rhythms.', options: ['Agree', 'Neutral', 'Disagree'] },
  { id: 'MBTI', emoji: '👤', title: 'Personality Assessment', framework: 'Personality Assessment', tag: 'Personality Type Preferences', hint: 'Helps you understand your personality type, work style, and preferences.', total: 20, question: 'I feel energized after spending time with a large group of people.', options: ['Agree', 'Neutral', 'Disagree'] },
  { id: 'VAK', emoji: '📚', title: 'Learning Style Assessment', framework: 'Learning Style Assessment', tag: 'Learning Style Preferences', hint: 'Discovers how you learn and retain information most effectively.', total: 18, question: 'I remember things best when I see them written down or drawn.', options: ['Agree', 'Neutral', 'Disagree'] },
  { id: 'DISC', emoji: '🤝', title: 'Professional Behaviour & Work Style Analysis', framework: 'Professional Behaviour & Work Style Analysis', tag: 'Work Style & Behaviour', hint: 'Understands how you communicate, collaborate, and respond in different situations.', total: 16, question: 'I prefer to take charge and make quick decisions in a team.', options: ['Agree', 'Neutral', 'Disagree'] },
  { id: 'BIG5', emoji: '💡', title: 'Workplace Personality & Success Factors Analysis', framework: 'Workplace Personality & Success Factors Analysis', tag: 'Workplace Personality Factors', hint: 'Identifies your core personality traits, behavioural patterns, and strengths.', total: 22, question: 'I stay organized and plan things well in advance.', options: ['Agree', 'Neutral', 'Disagree'] },
  { id: 'CARL_JUNG', emoji: '🎯', title: 'Decision-Making & Thinking Style Assessment', framework: 'Decision-Making & Thinking Style Assessment', tag: 'Thinking & Decision Style', hint: 'Explains how you think, process information, and make decisions.', total: 20, question: 'I prefer to rely on logic rather than feelings when making decisions.', options: ['Agree', 'Neutral', 'Disagree'] },
];
