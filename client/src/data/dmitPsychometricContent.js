/** Brain Mapping + Skill Mapping combo — complete assessment + counselling */
...
export const COMBO_STEPS = [
  ...
  },
  {
    ...
    desc: 'Single holistic report merging inborn (Brain Mapping) + acquired (Skill Mapping) insights — your complete talent profile.',
    icon: '📋',
  },
  {
    step: '04',
