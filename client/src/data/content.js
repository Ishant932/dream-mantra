...
export const IMAGES = {
  ...
  dmit: '/images/mapping/classroom.png',
  fingerprint: u('photo-1576091160550-2173dba999ef'),
  psychometric: '/images/mapping/test.png',
  skillMapping: '/images/mapping/classroom.png',
  comboMind: '/images/mapping/session.png',
  comboSkill: '/images/mapping/campus.png',
  /** Generated Indian-student polaroids for mapping heroes */
  dmitCollage: [
