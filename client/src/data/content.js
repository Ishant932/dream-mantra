...
export const IMAGES = {
  ...
  dmit: '/images/mapping/brain-hero.png',
  fingerprint: u('photo-1576091160550-2173dba999ef'),
  psychometric: '/images/mapping/skill-hero.png',
  skillMapping: '/images/mapping/skill-hero.png',
  comboMind: '/images/mapping/combo-hero.png',
  comboSkill: '/images/mapping/students-crowd.png',
  /** Indian-student hero polaroids — distinct per program */
  dmitCollage: [
    '/images/mapping/brain-hero.png',
    '/images/mapping/classroom.png',
    '/images/mapping/session.png',
    '/images/mapping/campus.png',
  ],
  psychoCollage: [
    '/images/mapping/skill-hero.png',
    '/images/mapping/test.png',
    '/images/mapping/students-crowd.png',
    '/images/mapping/classroom.png',
  ],
  comboCollage: [
    '/images/mapping/combo-hero.png',
    '/images/mapping/brain-hero.png',
    '/images/mapping/skill-hero.png',
    '/images/mapping/students-crowd.png',
  ],
